...
3.  **Core System Telemetry:** 60-second updates of CPU Temperature, CPU Usage percentage, RAM percentage, root disk percentage utilization, system load averages (1m, 5m, 15m), and network interface bandwidth (RX/TX kB/s rates).
